...
export const STRINGS: Record<string, { en: string; zh: string }> = {
  ...
  'secrets.filterTenant':  { en: 'Tenant scope', zh: '租户范围' },
  ...
  'secrets.create.scopeHint': { en: 'Tenant secrets are available to all sandboxes. Sandbox scope binds to one sandbox.', zh: '租户凭据可被该租户下所有 sandbox 使用。sandbox 范围只绑定一个 sandbox。' },
